...
const nextConfig: NextConfig = {
  async headers() {
    const contentSecurityPolicy = [
      ...
      "img-src 'self' data: blob: https://cdn.reptiles.ge https://upload.wikimedia.org https://server.arcgisonline.com https://www.googletagmanager.com https://www.google-analytics.com https://stats.g.doubleclick.net https://*.google.com https://*.google.ge https://counter.top.ge",
  ...
  async redirects() {
    return [
      ...
      {
        destination: "/kontributorebi/:slug",
      ...
      ...latinRedirects([
        ...
        ["/identify", "/species"],
        ["/avtorebi/:slug", "/contributors/:slug"],
        ["/authors/:slug", "/contributors/:slug"],
        ["/fotografebi/:slug", "/contributors/:slug"],
        ["/photographers/:slug", "/contributors/:slug"],
        ["/kontributorebi/:slug", "/contributors/:slug"],
