...
export async function FinalCTA() {
  ...
  return (
    <section className="relative flex min-h-[28rem] items-end overflow-hidden bg-ink sm:min-h-[32rem] lg:min-h-[38rem]">
      <CoverImage
        src={images.cta}
        alt={t("imageAlt")}
        sizes="100vw"
      ...
      <div className="relative mx-auto w-full max-w-[1400px] px-6 py-12 lg:px-10 lg:py-16">
        ...
        <h2 className="mt-4 max-w-2xl font-display text-balance-tight text-[clamp(1.7rem,3.6vw,2.75rem)] font-semibold leading-[1.1] text-white">
          {t("title")}
        </h2>
