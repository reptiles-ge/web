...
export const species: Species[] = [
  {
    ...
    diet:
      "იკვებება ძირითადად მცირე მღრღნელებით, ხვლიკებითა და ზოგჯერ ფრინველების ბარტყებით. ნადირობს ჩასაფრებით — უძრავად ელოდება მსხვერპლს და შხამიანი კბენით ანეიტრალებს.",
    behavior:
  ...
  },
  {
    ...
    diet:
      "იკვებება ირმებით, გარეული ღორებით, ფრინველებითა და ლეშით. ახალგაზრდები ხშირად ხეებზე ცხოვრობენ და მწერებით იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    diet:
      "იჭერს თევზებს, ფრინველებს, კაიმანებსა და ძუძუმწოვრებს. მსხვერპლს ახრჩობს და მთლიანად ყლაპავს.",
    behavior:
  ...
  },
  {
    ...
    diet:
      "იჭერს მწერებს გრძელი, წებოვანი ენით. ნადირობს ვიზუალურად — თვალები დამოუკიდებლად მოძრაობს.",
    behavior:
  ...
  },
  {
    ...
    diet:
      "იჭერს ჭიანჭველებს, ტერმიტებსა და სხვა მცირე უხერხემლოებს, საიდანაც ტოქსინებს იღებს.",
    behavior:
  ...
  },
  {
    ...
    diet:
      "ზრდასრულები ძირითადად ზღვის ბალახითა და წყალმცენარეებით იკვებებიან — აქედან მოდის სახელი „მწვანე“.",
    behavior:
