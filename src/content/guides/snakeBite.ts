...
const COPY: Record<AppLocale, GuideArticleCopy> = {
  ...
  ka: {
    ...
    title: "გველის ნაკბენი — რა უნდა გავაკეთოთ?",
  },
  ru: {
    description:
...
export const SNAKE_BITE = defineGuideArticle({
  ...
  hero: {
    ...
    height: 909,
    src: "https://cdn.reptiles.ge/images/guides/snake-bite-hero.jpg",
    width: 1730,
  },
  id: "snake-bite",
  images: {
    "call-112": {
      ...
      height: 1024,
      src: "https://cdn.reptiles.ge/images/guides/snake-bite-call-112.jpg",
      width: 1536,
    },
    "clinical-assessment": {
      alt: {
      ...
      height: 1024,
      src: "https://cdn.reptiles.ge/images/guides/snake-bite-clinical-assessment.jpg",
      width: 1536,
    },
    "keep-distance": {
      alt: {
      ...
      height: 1024,
      src: "https://cdn.reptiles.ge/images/guides/snake-bite-keep-distance.jpg",
      width: 1536,
    },
    "remove-ring": {
      alt: {
      ...
      height: 1024,
      src: "https://cdn.reptiles.ge/images/guides/snake-bite-remove-ring.jpg",
      width: 1536,
    },
  },
  messageKey: "bite",
