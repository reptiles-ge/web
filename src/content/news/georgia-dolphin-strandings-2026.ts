...
export const GEORGIA_DOLPHIN_STRANDINGS_2026: NewsArticle = {
  ...
  copy: {
    ka: {
      ...
      dek: "გუჩმანიძის 17 წლის სერიაში ეს ათ წელში ყველაზე მაღალი მაჩვენებელია. სააგენტომ მიზეზი არ დაასახელა.",
      lead: "იქთიოლოგი, ბიოლოგიის დოქტორი არჩილ გუჩმანიძე „ბათუმელებს“ 4 მაისს უთხრა, რომ 2026 წლის 1 მარტიდან 1 მაისამდე მხოლოდ სარფი–ანაკლიის მონაკვეთზე ზღვამ 40-მდე დელფინი გამორიყა. ეს მისი დაკვირვებით ბოლო ათი წლის ყველაზე მაღალი მაჩვენებელია. სანაპიროს გამორიყვას 17 წელია ითვლის. სახეობებად ეს 40 არ არის გაყოფილი.",
      sections: [
        {
          ...
          blocks: [
            {
              ...
              parts: [
                ...
                " მონაკვეთს ეხება, ორ თვეს. გუჩმანიძე ამბობს, რომ 17 წლის სერიაში ასეთი მონაცემი არ ჰქონია. 1 ივნისს „ბათუმელები“ კვარიათში კიდევ ერთ გამორიყვას აღწერს; ეს ორმოცში არ არის ჩათვლილი.",
              ],
            },
          ],
        },
          ...
          blocks: [
            {
              type: "p",
              parts: [
                "გუჩმანიძე ამბობს, რომ სტატისტიკის ზრდას შესწავლა სჭირდება და რომელმა ფაქტორმა იმოქმედა, ამ ეტაპზე დადგენილი არ არის. მაისში გარემოს ეროვნულმა სააგენტომ „ბათუმელებს“ უთხრა, რომ სპეციალისტები სანაპიროზე გავიდნენ, საბოლოო ინფორმაცია არ ჰქონდათ და სრული კვლევა ჯერ გადაწყვეტილი არ იყო. ივნისში სააგენტომ დაწერა, რომ კომპლექსური კვლევა ჩაატარა; გამორიყვის მიზეზი მაინც არ დაასახელა. ამ გვერდზე მიზეზს არ ვვარაუდობთ.",
              ],
            },
            {
              type: "p",
    ...
    en: {
      ...
      dek: "In Guchmanidze’s 17-year series this is the highest figure in ten years. The agency named no cause.",
    ...
    ru: {
      ...
      dek: "В 17-летней серии Гучманидзе это самый высокий показатель за десять лет. Агентство причину не назвало.",
    ...
    tr: {
      ...
      dek: "Guçmanidze’nin 17 yıllık dizisinde bu, on yılın en yüksek rakamı. Ajans nedeni adlandırmadı.",
