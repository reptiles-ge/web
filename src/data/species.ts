...
export const species: Species[] = [
  {
    ...
    overview:
      "დინიკის გველგესლა (Vipera dinniki) დიდი კავკასიონის ენდემია და გავრცელებულია რუსეთის, საქართველოსა და აზერბაიჯანის მაღალმთიან რეგიონებში. ცხოვრობს ტყის ზედა ზონაში, ბუჩქნარში, სუბალპურ და ალპურ მდელოებსა და კლდოვან ადგილებში — დაახლოებით 1,500–2,800 მეტრის სიმაღლეზე. შხამიანი სახეობაა; IUCN-ის მიხედვით მოწყვლადია, რადგან არეალი ფრაგმენტირებულია და ჰაბიტატის ხარისხი მცირდება.",
    habitat:
