...
export const species: Species[] = [
  ...
  },
  {
    ...
    "overview": "აღმოსავლური ვასაკა (Hyla orientalis) უშხამო ვასაკაა, რომელიც საქართველოს უმეტეს ნაწილში გვხვდება, გარდა უკიდურესი სამხრეთ-აღმოსავლეთის მშრალი ზონისა. 2026 წლის ქართული ჩამონათვალი მას ცალკე სახეობად იღებს. ზრდასრული ჩვეულებრივ დაახლოებით 3–5 სმ-ია. ადამიანისთვის საშიში არ არის. ეძებეთ ნათელ ტყეში, ბუჩქნარში, ბაღსა და წყალთან — არა ვაშლოვანის სტეპში. კოლხეთის დაბლობზე ხშირია. დასახელებული ადგილებია ბათუმი, ფოთი, ქუთაისი, ბორჯომი, თბილისი, თელავი, ყვარელი და ლაგოდეხი. 2026 წლის დნმ-ნიმუშები თბილისის ჩილის ტბიდან და წყორძის მიდამოებიდანაა. ნაშრომის ფიგურა გაღმა დვაბზუდანაა (გურია). უკიდურეს სამხრეთ-აღმოსავლეთში ვასაკა, როგორც წესი, მცირეაზიურია (Hyla savignyi). ძველ წიგნებში ხშირად იწერებოდა Hyla arborea ან Hyla arborea schelkownikowi. ჩამონათვალში კანდიდატია: ევროპული H. arborea-სგან გამოყოფა ძირითადად მიტოქონდრიულ დნმ-ს ეყრდნობა და დამატებით გენომურ შემოწმებას საჭიროებს. ეს არ ნიშნავს, რომ საქართველოში იშვიათია. მცირეაზიური ვასაკა ჩამონათვალში ბიოლოგიურად დადასტურებულია. აღმოსავლეთ საქართველოში ორი ვასაკის არეალი ერთმანეთს ეხება; იქ გენების გადასვლა სრულად არ არის გარკვეული.",
    "habitat": "საქართველოში ეს უფრო ტყისა და ნოტიო ადგილების ვასაკაა, ვიდრე სტეპის. ეძებეთ ნათელ ფოთლოვან ან შერეულ ტყეში, ბუჩქნარში, ბაღსა და წყალთან — ტბორთან, გუბესთან, ტბის ნაპირზე ან ნელ ნაკადულთან. მკვრივ ბნელ ტყეს ჩვეულებრივ არ ირჩევს. 1996 წლის მიმოხილვა მას ტყიან და სასოფლო ლანდშაფტში, განსაკუთრებით ბაღებში, ასახელებს და საქართველოს თითქმის მთელ ტერიტორიას მიაკუთვნებს, გარდა უკიდურესი სამხრეთ-აღმოსავლეთისა. დასახელებული ადგილებია შავი ზღვის სანაპირო (ბათუმი, ქობულეთი, ფოთი), ქუთაისი, ბორჯომი–ბაკურიანი, თბილისის მიდამოები (ლისის ტბა, კოჯორი, წყნეთი), თელავი, ყვარელი, ლაგოდეხი. 2026 წლის დნმ-ნიმუშები ჩილის ტბიდან (თბილისი) და წყორძის მიდამოებიდანაა. ატლასის რუკა ყველა რეგიონს აღნიშნავს, მათ შორის კახეთს, სადაც საკონტაქტო ზონაა; ივრის ხეობისა და ვაშლოვანის მშრალ ადგილას უფრო მცირეაზიური ვასაკაა. ზღვის დონიდან ზუსტი ზედა ზღვარი აქ არ არის დადგენილი. დიდი კავკასიონის ალპურ სარტყელში არ უნდა ეძებოთ. არეალი გრძელდება ჩრდილოეთ კავკასიაში, ანატოლიასა და შავი ზღვის გარშემო.",
    ...
    "identification": {
      ...
      "traits": [
        ...
        "ზურგი უმეტესად მწვანეა, მაგრამ ნაცრისფერი ან მოყავისფრო შეიძლება გახდეს. ფერი ტემპერატურისა და ფონის მიხედვით იცვლება. გვერდზე ხშირად მუქი ზოლია, რომელიც საზარდულთან მარყუჟს ქმნის; მხოლოდ ამ ზოლზე დაყრდნობა შეცდომას იწვევს, რადგან ზოგი აღმოსავლური ვასაკას ზოლი მარყუჟის გარეშეა, ზოგი მცირეაზიურის კი — მარყუჟით.",
  ...
  },
  {
    ...
    "overview": "კავკასიური ჩვეულებრივი ტრიტონი (Lissotriton lantzi) უშხამო პატარა ტრიტონია, რომელიც საქართველოში ტყის სარტყლის გუბეებსა და ტბებში გვხვდება. ზრდასრული ჩვეულებრივ დაახლოებით 7–11 სმ-ია; მამრი შეწყვილებისას დაახლოებით 12 სმ-მდე შეიძლება იყოს. ადამიანისთვის საშიში არ არის. 2026 წლის ქართული ჩამონათვალი მას კანდიდატ სახეობად იღებს: ეს არის ჩვეულებრივი ტრიტონის (L. vulgaris) კომპლექსის გეოგრაფიულად იზოლირებული ხაზი. პრაქტიკული დასკვნა ველისთვის: საქართველოში ეს არის პატარა, გლუვკანიანი ტბის ტრიტონი — არა ზოლებიანი და არა სავარცხლიანი ტრიტონი. დნმ-ბარკოდი მწყემსის ტბიდანაა (თბილისი); ჰომოლოგიური მიმდევრობა ბაკურიანიდანაა. ნაშრომის ფიგურა თაბარუკი / მწყემსია. ძველ წიგნებში იწერებოდა Triturus vulgaris lantzi. ტიპური მასალა ვოლტერშტორფმა 1914 წელს ნოვოროსიისკიდან, ფოთიდან და ბორჯომიდან მიიღო.",
    "habitat": "საქართველოში ეს ტყის სარტყლის ტბისა და გუბის ტრიტონია. ეძებეთ უთევზო ან სუსტად დათევზებულ გუბეში, პატარა ტბაში, თხრილსა და ნელ წყალსატევში, ხშირად ფოთლოვან ან შერეულ ტყესთან. ხმელეთზე იმალება ქვის, მორის და ფოთლოვანი ნაგვის ქვეშ. 2026 წლის ჩამონათვალში გენეტიკურად დადასტურებული ადგილი მწყემსის ტბაა (თბილისი); ჰომოლოგიურად ნახსენებია ბაკურიანი; ფიგურა თაბარუკი / მწყემსია. ეს არ ნიშნავს, რომ სახეობა მხოლოდ თბილისშია. Tarkhnishvili 1996-ში 17 ქართული ადგილია, მათ შორის ბათუმი, სოხუმი, გაგრა, ბიჭვინთა, ქუთაისი, ბაკურიანი, ფოთი, მუხური, საქოჩავის ტბები, დიდი მიტარბი, სოფელი ტბა, ქობულეთი, ლაგოდეხი, სათაფლია, ჭიანთბა (თელავი), სატოვლე თბილისთან და ერტაწმინდა თრიალეთზე. აღმოსავლეთ საქართველოში ზოგი პოპულაცია უკვე მაშინ გადაშენებულად ითვლებოდა, მაგალითად ყვარლის მიდამოებში. Skorinov et al. 2014-ში საქართველოს ტერიტორიაზე 42 ლოკალიტეტია, ზღვის დონიდან მთის ტბებამდე — მათ შორის კოლხეთის დაბლობი, იმერეთი, ბორჯომი–ბაკურიანი, თრიალეთი, მანგლისი, კახეთი. ამ ატლასის რუკაზე აღნიშნულია აფხაზეთი, სამეგრელო — ზემო სვანეთი, გურია, აჭარა, იმერეთი, სამცხე — ჯავახეთი, შიდა ქართლი, მცხეთა — მთიანეთი, ქვემო ქართლი, კახეთი და თბილისი. რაჭა — ლეჩხუმი — ქვემო სვანეთში ამ გვერდის წყაროებში ცალკე ჩანაწერი არ არის. სიმაღლე საქართველოში ზღვის დონიდან დაახლოებით 1 800 მ-მდეა (ბაკურიანი, კახისის ტბა); სახეობის არეალში, რუსეთის კავკასიაში, უფრო მაღალ ჩანაწერებიცაა. არეალი გრძელდება ჩრდილოეთ კავკასიაში. სომხეთში, აზერბაიჯანსა და ჩრდილო-აღმოსავლეთ თურქეთში ძველი ჩანაწერებია; ბოლო ათწლეულების სანდო დადასტურება იქ მწირია და ზოგი პოპულაცია გადაშენებულად ითვლება.",
    ...
    "behavior": "გამრავლებისას წყალშია; დანარჩენ დროს ხშირად ხმელეთზეა. ჩვეულებრივ ტრიტონებზე უფრო წყალთან ასოცირებულად აღწერენ. საქართველოს ყველა პოპულაციის ზუსტი კალენდარი ამ გვერდზე არ არის. ჩრდილო-დასავლეთ კავკასიაში, ტყვეობასა და საველე დაკვირვებაში, შეწყვილება გვიანი ზამთრიდან ზაფხულის დასაწყისამდეა, პიკი ხშირად თებერვალ–აპრილია; მაღალ სიმაღლეზე პერიოდი გვიანდება. კვერცხს ცალ-ცალკე დებს წყლის მცენარის ფოთოლზე. ლიფსიტა წყალში იზრდება და მეტამორფოზის შემდეგ ხმელეთზე გადის. ზოგ პოპულაციაში აღწერილია პედომორფოზი: ზრდასრულს ლიფსიტის ნიშნები, მათ შორის ლაყუჩები, რჩება. თუ შეხვდებით, დააკვირდით და დატოვეთ ადგილზე. არ აიყვანოთ და წყალსატევებს შორის არ გადაიტანოთ — ასე ადვილად ვრცელდება დაავადება. კანის ჯირკვლები თავდაცვით სეკრეტს გამოყოფს; შეხების შემდეგ ხელები დაიბანეთ. ადამიანისთვის სამედიცინო საფრთხე არ არის.",
    "conservation": "ჩამონათვალში კანდიდატი სახეობაა. სახეობრივი რანგი L. vulgaris-ის კომპლექსში დამატებით შემოწმებას საჭიროებს. Pabijan et al. კომპლექსის უძველეს იზოლირებულ ხაზად მიიჩნევენ (გვიანი მიოცენი; იზოლაცია დაახლოებით 6.4 მლნ წელი); ეს დრო შეიძლება საკმარისი არ იყოს სრული რეპროდუქციული იზოლაციისთვის. Wielstra et al. 2018 ცალკე სახეობად იღებენ. Tarkhnishvili et al. 2026: Frost ცალკე სახეობად ასახელებს, Raffaëlli 2022 — არა. ITIS, Amphibian Species of the World 6.2-ზე (2025 წლის 15 სექტემბერი) დაყრდნობით, სახელს L. vulgaris-ის უმცროს სინონიმად მიიჩნევს. Mars et al. 2025 ფილოგენომიკით ქვესახეობას (L. v. lantzi) ურჩევენ, რადგან ცალკე სახეობა L. vulgaris-ს პარაფილეტურს დატოვებდა. IUCN ცალკე L. lantzi-ს არ აფასებს; L. vulgaris მცირე საფრთხის ქვეშაა (Least Concern). საქართველოს წითელ ნუსხაში Skorinov et al. 2014-ის მიხედვით არ არის. რუსეთის წითელ წიგნში შედის. მთავარი საფრთხეებია გუბის განადგურება ან შევსება, თევზის შეყვანა, ტყის გაჩეხვა და ტერარიუმის ვაჭრობა. აღმოსავლეთ საქართველოში ადგილობრივი კლება უკვე 1990-იანებში იყო აღწერილი.",
    "danger": "Harmless",
    ...
    "identification": {
      ...
      "traits": [
        "სხეული წვრილი და წაგრძელებულია. კანი გლუვია ან წვრილად მარცვლოვანი — არა უხეში, როგორც სავარცხლიან ტრიტონს. კუდი გვერდებზე გაბრტყელებულია წყალში და სხეულს დაახლოებით უტოლდება. ზრდასრული ჩვეულებრივ დაახლოებით 7–11 სმ-ია სრული სიგრძით; მამრი შეწყვილების კაბაში დაახლოებით 12 სმ-მდე აღწერილია. ქართული გაზომვები ამ გვერდზე ცალკე არ არის.",
        "ზურგი ზეითუნისფერი, მოყავისფრო ან მოყვითალოა, წვრილი მუქი წერტილებით ან ლაქებით. გვერდზე ვერცხლისფერი ზოლი არ არის — ეს მთავარი განსხვავებაა კავკასიური ტრიტონისგან. მუცელი ყვითელი ან ნარინჯისფერია. მამრს მუცელზე დიდი მუქი ლაქები აქვს, მდედრს — ძალიან წვრილი.",
...
export const speciesEn: Record<string, SpeciesTranslation> = {
  ...
  "hyla-orientalis": {
    ...
    "overview": "The eastern treefrog (Hyla orientalis) is a harmless treefrog found through most of Georgia, except the dry far south-east. The 2026 Georgian checklist treats it as a distinct species. Adults are usually about 3–5 cm long. It is not dangerous to people. Look for it in open woodland, shrub, gardens and near water — not in the Vashlovani steppe. It is common in the Colchic lowlands. Named sites include Batumi, Poti, Kutaisi, Borjomi, Tbilisi, Telavi, Kvareli and Lagodekhi. The 2026 checklist DNA samples are from Chili Lake in Tbilisi and the Tskordza area. The checklist figure is Gaghma Dvabzu in Guria. In the far south-east a treefrog is usually the yellow-lemon treefrog (Hyla savignyi). Older books often listed it as Hyla arborea or Hyla arborea schelkownikowi. The checklist treats it as a candidate species: the split from European H. arborea rests mainly on mitochondrial DNA and still needs genomic checks. That does not mean it is rare in Georgia. The yellow-lemon treefrog is biologically confirmed in the checklist. In eastern Georgia the two treefrogs meet; gene flow across that contact zone is not fully resolved.",
    "habitat": "In Georgia this is a treefrog of woodland and humid country, not of dry steppe. Look for it in open broadleaf or mixed forest, shrub, gardens and near water — ponds, pools, lake edges or slow streams. It usually avoids dense dark forest. The 1996 review places it in forested and farmed landscapes, especially orchards, across almost all of Georgia except the far south-east. Named sites include the Black Sea coast (Batumi, Kobuleti, Poti), Kutaisi, the Borjomi–Bakuriani area, the Tbilisi district (Lisi Lake, Kojori, Tskneti), Telavi, Kvareli and Lagodekhi. The 2026 DNA samples are from Chili Lake (Tbilisi) and the Tskordza area. This atlas marks every region, including Kakheti, where the contact zone lies; in the dry Iori valley and Vashlovani a treefrog is more likely H. savignyi. The upper elevation in Georgia is not established on this page. Do not expect it on the alpine belt of the Greater Caucasus. The range continues in the North Caucasus, Anatolia and around the Black Sea.",
    ...
    "identification": {
      ...
      "traits": [
        ...
        "The back is usually green, but it can turn grey or brown. Colour changes with temperature and background. A dark side stripe often forms a loop at the groin; that stripe alone is unreliable, because some eastern treefrogs lack the loop and some yellow-lemon treefrogs show one.",
  ...
  "lissotriton-lantzi": {
    ...
    "overview": "The Caucasian smooth newt (Lissotriton lantzi) is a small, harmless newt of forest ponds and lakes in Georgia. Adults are usually about 7–11 cm long; breeding males may reach about 12 cm. It is not dangerous to people. The 2026 Georgian checklist treats it as a candidate species: a geographically isolated lineage of the smooth newt (L. vulgaris) complex. For field use the practical point is simple: this is Georgia’s small, smooth-skinned pond newt — not the banded newt and not the crested newt. The checklist barcode is from Mtskemsi Lake (Tbilisi); a homologous sequence is from Bakuriani. The paper’s figure is Tabaruki / Mtskemsi. Older books listed it as Triturus vulgaris lantzi. Wolterstorff’s 1914 material came from Novorossiysk, Poti and Borjomi.",
    "habitat": "In Georgia this is a newt of still water in the forest belt. Look for it in fish-free or lightly stocked ponds, small lakes, ditches and slow water, often beside deciduous or mixed woodland. On land it hides under stones, logs and leaf litter. The 2026 checklist’s DNA record is Mtskemsi Lake (Tbilisi); Bakuriani is cited as a homologous sequence; the figure locality is Tabaruki / Mtskemsi. That is not the whole Georgian range. Tarkhnishvili 1996 lists 17 Georgian localities, including Batumi, Sukhumi, Gagra, Pitsunda, Kutaisi, Bakuriani, Poti, Mukhuri, the Sakochavi lakes, Didi Mitarbi, the village of Tba, Kobuleti, Lagodekhi, Sataplia, Chiantba near Telavi, Satovle near Tbilisi and Ertatsminda on Trialeti. Some eastern populations were already treated as lost by then, for example near Kvareli. Skorinov et al. 2014 compile 42 localities in Georgia, from the Colchis lowland through Imereti, Borjomi–Bakuriani, Trialeti, Manglisi and Kakheti. This atlas marks Abkhazia, Samegrelo — Zemo Svaneti, Guria, Adjara, Imereti, Samtskhe — Javakheti, Shida Kartli, Mtskheta — Mtianeti, Kvemo Kartli, Kakheti and Tbilisi. There is no separate record in the sources used here for Racha — Lechkhumi — Kvemo Svaneti. Elevation in Georgia runs from the coast to about 1,800 m (Bakuriani, Kakhisi Lake); higher records exist in the Russian Caucasus. The range continues in the North Caucasus. Old records exist for Armenia, Azerbaijan and north-eastern Turkey; recent confirmation there is scarce and some populations are treated as extinct.",
    ...
    "behavior": "It is in water when breeding; at other times it is often on land. Accounts describe it as more aquatic than the northern smooth newt. A full calendar for every Georgian population is not given here. In the north-western Caucasus, in captivity and in the field, courtship runs from late winter to early summer, often peaking in February–April; at higher elevation the season is later. Eggs are laid singly on water plants. Larvae grow in water and leave it after metamorphosis. Paedomorphosis — adults that keep larval traits, including gills — has been recorded in some populations. If you find one, watch it and leave it where it is. Do not pick it up or move it between water bodies: that spreads disease. Skin glands produce a defensive secretion; wash your hands after any contact. It is not a medical risk to people.",
    "conservation": "Candidate species in the checklist. Species rank within the L. vulgaris complex still needs further tests. Pabijan et al. treat it as the oldest isolated lineage in the complex (late Miocene; isolation about 6.4 million years); that span may not be enough for full reproductive isolation. Wielstra et al. 2018 accept it as a species. Tarkhnishvili et al. 2026 note that Frost lists it as a species and Raffaëlli 2022 does not. ITIS, citing Amphibian Species of the World 6.2 (15 September 2025), treats the name as a junior synonym of L. vulgaris. Mars et al. 2025 recommend subspecies rank (L. v. lantzi), because full species status would leave L. vulgaris paraphyletic. IUCN does not assess L. lantzi separately; L. vulgaris is Least Concern. Skorinov et al. 2014 state that it is absent from the Georgian Red List. It is listed in the Red Data Book of Russia. Main threats are destruction or infilling of ponds, fish stocking, deforestation and the pet trade. Local decline in eastern Georgia was already described in the 1990s.",
    "stats": [
      {
        "label": "Habitat",
    ...
    "identification": {
      ...
      "traits": [
        ...
        "The back is olive, brownish or yellowish with small dark specks or spots. There is no silvery flank stripe — that is the main difference from the northern banded newt. The belly is yellow to orange. Males have large dark belly spots; females have very small ones.",
