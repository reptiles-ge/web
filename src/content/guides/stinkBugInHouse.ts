...
const COPY: Record<AppLocale, GuideArticleCopy<ImageKey>> = {
  ...
  ka: {
    ...
    metaTitle: "ფაროსანა სახლში - როგორ მოვიშოროთ",
    sections: [
      {
    ...
    title: "ფაროსანა სახლში - როგორ მოვიშოროთ",
  },
  ru: {
    description:
...
export const STINK_BUG_IN_HOUSE = defineGuideArticle({
  ...
  hero: {
    ...
    height: 941,
    src: "https://cdn.reptiles.ge/images/guides/stink-bug-house-hero.jpg",
    width: 1672,
  },
  ...
  images: {
    gap: {
      ...
      height: 941,
      src: "https://cdn.reptiles.ge/images/guides/stink-bug-window-gap.jpg",
      width: 1672,
    },
    sealing: {
      alt: {
      ...
      height: 941,
      src: "https://cdn.reptiles.ge/images/guides/stink-bug-sealing-frame.jpg",
      width: 1672,
    },
    "soapy-water": {
      alt: {
      ...
      height: 941,
      src: "https://cdn.reptiles.ge/images/guides/stink-bug-soapy-water.jpg",
      width: 1672,
    },
  },
  messageKey: "stinkBugInHouse",
  ogImage: "https://cdn.reptiles.ge/og/images/guides/stink-bug-in-house.jpg",
  parentHub: "insects",
  ...
  search: {
    ...
    title: {
      ...
      ka: "ფაროსანა სახლში - როგორ მოვიშოროთ",
