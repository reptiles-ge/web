...
> = {
  "araneus-diadematus": {
    ka: "ჩვეულებრივი ჯვრიანა (Araneus diadematus) საქართველოში — როგორ ამოიცნოთ თეთრი ჯვრის მქონე ობობა, სად არის დადასტურებული და რამდენად საშიშია ადამიანისთვის.",
  },
  "argiope-bruennichi": {
