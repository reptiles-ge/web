...
const HUB_COPY: Record<GroupHubId, PageCopy> = {
  ...
  scorpions: {
    ...
    subtitle: {
      en: "Scorpion profiles in the nature atlas",
      ka: "მორიელების პროფილები ბუნების ატლასში",
      ru: "Профили скорпионов в атласе природы",
      tr: "Doğa atlasında akrep profilleri",
    },
    title: {
      en: "Scorpions in Georgia",
      ka: "მორიელები საქართველოში",
      ru: "Скорпионы Грузии",
      tr: "Gürcistan akrepleri",
    },
  },
  snakes: {
    icon: "hub",
