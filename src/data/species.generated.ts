...
export const species: Species[] = [
  {
    ...
    overview:
      "შიშველთვალა სცინკი (Ablepharus pannonicus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
    ...
    behavior:
      "ხშირად ფარულია; ბევრი სცინკი სწრაფად მოძრაობს ფოთლოვან საფარში ან ქვების ქვეშ.",
    conservation:
      "საქართველოში დაფიქსირებულია. ადგილობრივ საფრთხეებს შეიძლება ჰაბიტატის დეგრადაცია და ამოღება მიეკუთვნებოდეს.",
    danger: "Harmless",
  ...
  },
  {
    ...
    location: "საქართველო",
    description:
      "ბოხმეჭა — დაფიქსირებულია საქართველოში. ჩეკლისტში კანდიდატი სახეობაა.",
    overview:
      "ბოხმეჭა (Anguis colchica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
  ...
  },
  {
    ...
    overview:
      "კავკასიური გომბეშო (Bufo verrucosissimus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    ...
    behavior:
      "აქტივობა სეზონურია და ტენიანობაზეა დამოკიდებული; ბევრი სახეობა მრავლდება წყაროებში, ტბორებში ან ნაკადულებში.",
    conservation:
      "საქართველოში დაფიქსირებულია. გლობალური და ეროვნული სტატუსი იხილეთ IUCN-სა და ეროვნულ შეფასებებში.",
    danger: "Harmless",
  ...
  },
  {
    ...
    overview:
      "მწვანე გომბეშო (Bufotes viridis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "აჭარული კლდის ხვლიკი (Darevskia adjarica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
      "ძირითადად დღისით აქტიურია; ბევრი სახეობა ქვებზე ან მცენარეებზე თბება და საფრთხისას ნაპრალებში იფარება.",
    conservation:
      "საქართველოში დაფიქსირებულია. ადგილობრივ საფრთხეებს შეიძლება ჰაბიტატის დეგრადაცია და ამოღება მიეკუთვნებოდეს.",
    danger: "Harmless",
  ...
  },
  {
    ...
    overview:
      "აფხაზეთის კლდის ხვლიკი (Darevskia alpina) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "სომხური კლდის ხვლიკი (Darevskia armeniaca) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ბრაუნერის კლდის ხვლიკი (Darevskia brauneri) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "კავკასიონის ხვლიკი (Darevskia caucasica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    description: "ლაზური ხვლიკი — დაფიქსირებულია საქართველოში.",
    overview:
      "ლაზური ხვლიკი (Darevskia clarkorum) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
    ...
    facts: [],
    identification: {
      summary: "როგორ ამოვიცნოთ ლაზური ხვლიკი.",
      traits: [
        "პატარა ლაცერტიდი ხვლიკი; ბევრი Darevskia სახეობა მსგავსია და საჭიროებს ყურადღებით შედარებას.\n",
        "ხშირად კლდეებსა და ქვის ზედაპირებთანაა დაკავშირებული.\n",
        "კავკასიაში იდენტიფიკაცია რეგიონული გასაღებებითა და გადამოწმებული ფოტოებით უნდა მოხდეს.\n",
    ...
    faq: [
      ...
      {
        question: "რითი იკვებება ლაზური ხვლიკი?\n",
        answer:
          "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.\n",
      },
    ],
  ...
  },
  {
    ...
    overview:
      "დაღესტნური ხვლიკი (Darevskia daghestanica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "დალის ხვლიკი (Darevskia dahli) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    family: "Lacertidae",
    location: "საქართველო",
    description: "კავკასიური ტყის ხვლიკი — დაფიქსირებულია საქართველოში.",
    overview:
      "კავკასიური ტყის ხვლიკი (Darevskia derjugini) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
    ...
    facts: [],
    identification: {
      summary: "როგორ ამოვიცნოთ კავკასიური ტყის ხვლიკი.",
      traits: [
        "პატარა ლაცერტიდი ხვლიკი; ბევრი Darevskia სახეობა მსგავსია და საჭიროებს ყურადღებით შედარებას.\n",
        "ხშირად კლდეებსა და ქვის ზედაპირებთანაა დაკავშირებული.\n",
        "კავკასიაში იდენტიფიკაცია რეგიონული გასაღებებითა და გადამოწმებული ფოტოებით უნდა მოხდეს.\n",
    ...
    faq: [
      ...
      {
        question: "რითი იკვებება კავკასიური ტყის ხვლიკი?\n",
        answer:
          "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.\n",
      },
    ],
  ...
  },
  {
    ...
    overview:
      "კოლხური კლდის ხვლიკი (Darevskia mixta) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "მესხური კლდის ხვლიკი (Darevskia obscura) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "კოლხური მდელოს ხვლიკი (Darevskia pontica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "მტკვრის ხვლიკი (Darevskia portschinskii) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "მდელოს ხვლიკი (Darevskia praticola) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "რადეს ხვლიკი (Darevskia raddei) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ვალენტინის ხვლიკი (Darevskia valentini) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "კლდოვანი ამონაკვეთები, კლდეები, ქვის კედლები და ღია მთის ან მთისწინა ფერდობები.",
    diet: "ძირითადად წვრილი უხერხემლოები, განსაკუთრებით მწერები და ობობები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ყვითელმუცელა მცურავი (Dolichophis caspius) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, კლდოვანი ფერდობები ან ტყის პირას — სახეობის მიხედვით.",
    diet: "წვრილი ხერხემლიანები და/ან უხერხემლოები სახეობის მიხედვით — ხვლიკები, მღრღნელები, ამფიბიები ან მწერები.",
    behavior:
      "აქტივობა სახეობის მიხედვითაა — დღის მონადირეებიდან ფარულ მიწისქვეშა ან ღამის სახეობებამდე.",
    conservation:
      "საქართველოში დაფიქსირებულია. გლობალური სტატუსი იხილეთ IUCN-ში.",
    danger: "Harmless",
  ...
  },
  {
    ...
    overview:
      "საყელოიანი ეირენისი (Eirenis collaris) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
  ...
  },
  {
    ...
    overview:
      "წყნარი ეირენისი (Eirenis modestus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ქვიანი ფერდობები და მშრალი ღია ჰაბიტატები თავშესაფრით ქვების ქვეშ.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ჭაობის კუ (Emys orbicularis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    ...
    conservation:
      "საქართველოში დაფიქსირებულია. ბევრ კუს სახეობას მსოფლიოში ჰაბიტატის დაკარგვა და ამოღება ემუქრება.",
    danger: "Harmless",
  ...
  },
  {
    ...
    overview:
      "ფერადი ფსვენი (Eremias arguta) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
      "ძირითადად დღისით აქტიურია; ბევრი სახეობა ქვებზე ან მცენარეებზე თბება და საფრთხისას ნაპრალებში იფარება.",
    conservation:
  ...
  },
  {
    ...
    overview:
      "მარდი ფსვენი (Eremias velox) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "დასავლური მახრჩობელა (Eryx jaculus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
  ...
  },
  {
    ...
    overview:
      "გრძელფეხა სცინკი (Eumeces schneiderii) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ფხვიერი ნიადაგი, ფოთლების საფარი, ქვები და მშრალი ღია ჰაბიტატები.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ნაირფერი მცურავი (Hemorrhois ravergieri) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, კლდოვანი ფერდობები ან ტყის პირას — სახეობის მიხედვით.",
    diet: "წვრილი ხერხემლიანები და/ან უხერხემლოები სახეობის მიხედვით — ხვლიკები, მღრღნელები, ამფიბიები ან მწერები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "აღმოსავლური ვასაკა (Hyla orientalis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "მცირეაზიური ვასაკა (Hyla savignyi) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "მარდი ხვლიკი (Lacerta agilis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "კავკასიური მწვანე ხვლიკი (Lacerta media) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
    ...
    facts: [],
    identification: {
      summary: "როგორ ამოვიცნოთ კავკასიური მწვანე ხვლიკი.",
      traits: [
    ...
    faq: [
      ...
      {
        question: "რითი იკვებება კავკასიური მწვანე ხვლიკი?\n",
        answer:
          "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.\n",
      },
    ],
  ...
  },
  {
    ...
    overview:
      "ზოლიანი ხვლიკი (Lacerta strigata) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "კავკასიური ჩვეულებრივი ტრიტონი (Lissotriton lantzi) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
  ...
  },
  {
    ...
    overview:
      "აღმოსავლური ხვლიკიჭამია გველი (Malpolon insignitus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტი მას კანდიდატ სახეობად განიხილავს. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
  ...
  },
  {
    ...
    overview:
      "კასპიური კუ (Mauremys caspica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat: "ტბორები, ტბები, ნელი მდინარეები და ჭაობები.",
    diet: "სახეობის მიხედვით — ბალახისმჭამელი სახმელეთო კუებიდან ომნივორულ მტკნარი წყლის კუებამდე.",
    behavior:
      "წყლის კუები ხშირად დღისით თბებიან; სახმელეთო კუები აქტიურია თბილ ამინდში.",
  ...
  },
  {
    ...
    overview:
      "კავკასიური სალამანდრა (Mertensiella caucasica) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat: "გრილი ტენიანი ტყეები, ნაკადულები და მთის ჭაობები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
      "აქტივობა სეზონურია და ტენიანობაზეა დამოკიდებული; ბევრი სახეობა მრავლდება წყაროებში, ტბორებში ან ნაკადულებში.",
  ...
  },
  {
    ...
    overview:
      "კავკასიური ტრიტონი (Ommatotriton ophryticus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat: "გრილი ტენიანი ტყეები, ნაკადულები და მთის ჭაობები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
      "აქტივობა სეზონურია და ტენიანობაზეა დამოკიდებული; ბევრი სახეობა მრავლდება წყაროებში, ტბორებში ან ნაკადულებში.",
  ...
  },
  {
    ...
    overview:
      "კოხტა გველთავა (Ophisops elegans) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ჯოჯო (Paralaudakia caucasia) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
  ...
  },
  {
    ...
    overview:
      "სირიული მყვარი (Pelobates syriacus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "კავკასიური ჯვარულა (Pelodytes caucasicus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ტბორის ბაყაყი (Pelophylax ridibundus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ლიბანური ხვლიკი (Phoenicolacerta laevis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. საქართველოში შემოტანილია. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, ტყის პირას ან ქვიშიანი/სტეპური ჰაბიტატები სახეობის მიხედვით.",
    diet: "ძირითადად მწერები და სხვა წვრილი უხერხემლოები; უფრო დიდმა ხვლიკებმა შეიძლება წვრილი ხერხემლიანებიც შეიჭამონ.",
    behavior:
  ...
  },
  {
    ...
    family: "Ranidae",
    location: "საქართველო",
    description: "კავკასიური მურა ბაყაყი — დაფიქსირებულია საქართველოში.",
    overview:
      "კავკასიური მურა ბაყაყი (Rana macrocnemis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ჭაობები, ტბორები, ტენიანი ტყეები ან გამრავლების წყალთან ახლოს ღია ჰაბიტატები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
    ...
    facts: [],
    identification: {
      summary: "როგორ ამოვიცნოთ კავკასიური მურა ბაყაყი.",
      traits: [
        "ზრდასრულობაში უკუდო ამფიბია.\n",
        "ტენიანი კანი; ბევრ ბაყაყს გრძელი უკანა ფეხები აქვს.\n",
        "გამრავლების სეზონში ბევრი ანურა ყვირის.\n",
    ...
    faq: [
      ...
      {
        question: "რითი იკვებება კავკასიური მურა ბაყაყი?\n",
        answer:
          "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.\n",
      },
    ],
    ...
    faq: [
      {
        ...
        answer:
          "არა — ადამიანისთვის უვნებელია. უკანა კბილებიანი შხამი აქვს, მაგრამ კბილები პირის უკანაა და ადამიანის ეფექტურ დაშხამვას თითქმის შეუძლებელს ხდის; შხამი ძირითადად მცირე მსხვერპლისთვისაა.",
      },
      {
        question: "სად გვხვდება საქართველოში?",
        answer:
  ...
  },
  {
    ...
    family: "Gekkonidae",
    location:
      "საქართველო — ბუნებრივი არეალი უკიდურეს სამხრეთ-აღმოსავლეთში; აგრეთვე სინანთროპული პოპულაციები აღმოსავლეთის დასახლებებში და დაფიქსირებულია ქუთაისსა და სოხუმში",
    description:
      "პატარა ღამის გეკონი საქართველოდან — ბუნებრივი არეალი უკიდურეს სამხრეთ- აღმოსავლეთში, აგრეთვე ზოგიერთ დასახლებაში.",
    overview:
    ...
    habitat:
      "კლდოვანი და ურბანული კედლები, ქვის გროვები და მშრალი ღია ჰაბიტატები; საქართველოში ბუნებრივი არეალი უკიდურესი სამხრეთ-აღმოსავლეთია, დამატებითი სინანთროპული კოლონიებით ქალაქებში.",
    diet: "ღამის მწერიჭამია — ძირითადად წვრილი ფეხსახსრიანები.",
    behavior:
      "ძირითადად ღამის/ბინდის გეკონი; ცოცავს ვერტიკალურ ზედაპირებზე და დღისით ნაპრალებში იმალება.",
    conservation:
      "საქართველოში დაფიქსირებულია. ადგილობრივ საფრთხეებს შეიძლება ჰაბიტატის დეგრადაცია და ამოღება მიეკუთვნებოდეს.",
    danger: "Harmless",
  ...
  },
  {
    ...
    family: "Testudinidae",
    location:
      "საქართველო — T. g. ibera გავრცელებულია აღმოსავლეთ საქართველოში; T. g. nikolskii აღწერილია დასავლეთ საქართველოდან და იშვიათად ითვლება",
    description: "ხმელთაშუაზღვეთის კუ — დაფიქსირებულია საქართველოში.",
    overview:
      "ხმელთაშუაზღვეთის კუ (Testudo graeca) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "მშრალი მდელოები, ბუჩქნარი და ღია მთისწინეთი; ქვესახეობები განსხვავდება აღმოსავლეთ და დასავლეთ საქართველოში.",
  ...
  },
  {
    ...
    overview:
      "წითელყურა კუ (Trachemys scripta) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. საქართველოში შემოტანილია. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat: "ტბორები, ტბები, ნელი მდინარეები და ჭაობები.",
    diet: "სახეობის მიხედვით — ბალახისმჭამელი სახმელეთო კუებიდან ომნივორულ მტკნარი წყლის კუებამდე.",
    behavior:
      "წყლის კუები ხშირად დღისით თბებიან; სახმელეთო კუები აქტიურია თბილ ამინდში.",
    conservation:
      "შემოტანილია საქართველოში. შეიძლება კონკურენცია გაუწიოს ადგილობრივ წყლის კუებს.",
    danger: "Harmless",
  ...
  },
  {
    ...
    overview:
      "კარელინის სავარცხლიანი ტრიტონი (Triturus karelinii) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat: "გრილი ტენიანი ტყეები, ნაკადულები და მთის ჭაობები.",
    diet: "ძირითადად უხერხემლოები — მწერები, ჭიები და სხვა წვრილი მსხვერპლი; წყლის ლარვები ხშირად წვრილ წყლის უხერხემლოებს იკვებებიან.",
    behavior:
      "აქტივობა სეზონურია და ტენიანობაზეა დამოკიდებული; ბევრი სახეობა მრავლდება წყაროებში, ტბორებში ან ნაკადულებში.",
  ...
  },
  {
    ...
    identification: {
      summary:
        "ცხვირრქოსანი გველგესლა ევროპის ერთ-ერთი ყველაზე საშიში გველგესლაა. მთავარი ნიშანი ცხვირზე რქისებრი წარმონაქმნია — საქართველოში იშვიათია.",
      traits: [
  ...
  },
  {
    ...
    identification: {
      summary:
        "კავკასიური გველგესლა დასავლეთ კავკასიისა და კოლხური ტყეების ენდემური შხამიანი სახეობაა. ამოიცანი ჰაბიტატით (დაბალი სიმაღლე, ნოტიო დასავლეთი) და ზომით.",
      traits: [
  ...
  },
  {
    ...
    overview:
      "გველბრუცა (Xerotyphlops vermicularis) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
  ...
  },
  {
    ...
    overview:
      "ამიერკავკასიური მცურავი (Zamenis hohenackeri) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, კლდოვანი ფერდობები ან ტყის პირას — სახეობის მიხედვით.",
    diet: "წვრილი ხერხემლიანები და/ან უხერხემლოები სახეობის მიხედვით — ხვლიკები, მღრღნელები, ამფიბიები ან მწერები.",
    behavior:
  ...
  },
  {
    ...
    overview:
      "ესკულაპის მცურავი (Zamenis longissimus) საქართველოში დაფიქსირებულია ჩეკლისტში. ჩეკლისტში ბიოლოგიურად დადასტურებულადაა მითითებული. გვერდი აჯამებს გავრცელებასა და ზოგად ბიოლოგიას სამეცნიერო წყაროებიდან; დეტალური რეგიონები მხოლოდ მაშინაა მითითებული, როცა ეს პირდაპირაა დადასტურებული.",
    habitat:
      "ღია ადგილები, ბუჩქნარი, კლდოვანი ფერდობები ან ტყის პირას — სახეობის მიხედვით.",
    diet: "წვრილი ხერხემლიანები და/ან უხერხემლოები სახეობის მიხედვით — ხვლიკები, მღრღნელები, ამფიბიები ან მწერები.",
    behavior:
  ...
  },
  {
    ...
    behavior:
      "უმეტესად დღის აქტიურია; თბილ ამინდში შეიძლება საღამოსაც გამოჩნდეს. მშვიდი და ფრთხილია — საფრთხისას უპირატესად გაქცევას ცდილობს. ზრდასრული ხშირად ერთგვაროვანი ზეთისხილისფერი, მოყავისფრო ან მოყვითალო-ბრინჯაოსფერია; ქერცლების კიდეებზე ხშირად ჩანს თეთრი წერტილები. ახალგაზრდებს უფრო გამოკვეთილი ლაქებიანი ნახატი აქვთ. თავი შედარებით ვიწროა, გუგა მრგვალია; კისრის გვერდზე ხშირად ჩანს მოყვითალო ლაქა. კვერცხისმდებია: ივნის–ივლისის დასაწყისში დებს ჩვეულებრივ 4–10 კვერცხს ფხვიერ მიწაში ან ფოთლის ნაგვში; ნაშიერები აგვისტო–სექტემბერში იჩეკებიან.",
    conservation:
      "IUCN Red List-ზე გლობალურად ნაკლებად საფრთხის ქვეშაა (Least Concern) — არეალი ფართოა და პოპულაცია დიდია. თუმცა ლოკალურად შეიძლება იკლოს ჰაბიტატის გარდაქმნის, გზებზე დაღუპვისა და შხამიან გველთან აღრევის გამო მოკვლის შედეგად. საქართველოში შეტანილია წითელ წიგნში. ეკოსისტემისთვის სასარგებლოა — ამცირებს მღრღნელებს.",
    danger: "Harmless",
    image: "/images/zamenis-longissimus.jpg",
    imageCredit: {
    ...
    identification: {
      summary:
        "ესკულაპის მცურავი უშხამო, გლუვქერცლიანი მცურავია. ზრდასრული ხშირად ერთგვაროვანი ზეთისხილისფერია; კარგად ადის ხეებზე.",
      traits: [
    ...
    faq: [
      ...
      },
      {
        question: "სად გვხვდება საქართველოში?",
        answer:
          "უმეტესად დასავლეთში — აფხაზეთი, სამეგრელო, გურია, აჭარა, იმერეთი, რაჭა და კავკასიონის მთისწინეთი შავი ზღვის სანაპიროს გასწვრივ. იზოლირებული პოპულაცია აღინიშნა ჩრდილო-აღმოსავლეთში, ლაგოდეხის მიდამოებში. მშრალ აღმოსავლეთ სტეპებში თითქმის არ გვხვდება.",
      },
      {
        question: "რით განსხვავდება ანკარასგან (Natrix)?",
        answer:
          "ანკარა (Natrix natrix / N. tessellata) ნახევრადწყლის გველია — ხშირად ყვითელი „საყელოთი“ ან კუბიკური ლაქებით და უფრო მჭიდროდაა მიბმული წყალთან. ესკულაპის მცურავი უფრო გრძელი და მოქნილი ტყის მცურავია, ერთგვაროვანი ზეთისხილისფერი შეფერილობით და შესანიშნავი მთამსვლელი თვისებებით; იკვებება ძირითადად მღრღნელებითა და ფრინველებით.",
      },
      {
        question: "რას ჭამს?",
        answer:
          "მღრღნელებს, პატარა ფრინველებს, ბარტყებსა და კვერცხებს; ზოგჯერ ხვლიკებს. კარგად ადის ხეებზე ბუდეების მოსანახულებლად.",
      },
      {
        question: "კვერცხებს დებს თუ ცოცხლად შობს?",
        answer:
          "კვერცხისმდებია. ივნის–ივლისის დასაწყისში დებს ჩვეულებრივ 4–10 კვერცხს; ნაშიერები აგვისტო–სექტემბერში იჩეკებიან.",
      },
    ],
    updatedAt: "2026-08-05",
    sources: [
...
export const speciesEn: Record<string, SpeciesTranslation> = {
  "ablepharus-pannonicus": {
    ...
    overview:
      "Asian Snake-Eyed Skink (Ablepharus pannonicus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    ...
    conservation:
      "Recorded in Georgia. Local threats may include habitat degradation and collection.",
    stats: [
      {
        label: "Habitat",
  ...
  "anguis-colchica": {
    ...
    location: "Georgia",
    description:
      "Colchis Slow Worm — recorded from Georgia. Candidate species.",
    overview:
      "Colchis Slow Worm (Anguis colchica) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
  ...
  "bufo-verrucosissimus": {
    ...
    overview:
      "Caucasian Toad (Bufo verrucosissimus) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
    ...
    behavior:
      "Activity is strongly seasonal and tied to moisture; many species breed in springs, ponds or streams.",
    conservation:
      "Recorded in Georgia. Global and national conservation status should be checked in IUCN and Georgian assessments.",
    stats: [
      {
        label: "Habitat",
  ...
  "bufotes-viridis": {
    ...
    overview:
      "Green Toad (Bufotes viridis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "darevskia-adjarica": {
    ...
    description:
      "Ajarian Rock Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Ajarian Rock Lizard (Darevskia adjarica) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
    ...
    behavior:
      "Mostly diurnal; many species bask on rocks or vegetation and retreat to crevices when threatened.",
    conservation:
      "Recorded in Georgia. Local threats may include habitat degradation and collection.",
    stats: [
      {
  ...
  "darevskia-alpina": {
    ...
    description:
      "Alpine Rock Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Alpine Rock Lizard (Darevskia alpina) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-armeniaca": {
    ...
    overview:
      "Armenian Rock Lizard (Darevskia armeniaca) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-brauneri": {
    ...
    location: "Georgia",
    description:
      "Brauner's Rock Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Brauner's Rock Lizard (Darevskia brauneri) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-caucasica": {
    ...
    overview:
      "Caucasian Rock Lizard (Darevskia caucasica) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-clarkorum": {
    ...
    overview:
      "Clark's Rock Lizard (Darevskia clarkorum) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-daghestanica": {
    ...
    overview:
      "Daghestanian Rock Lizard (Darevskia daghestanica) is recorded from Georgia in. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-dahli": {
    ...
    overview:
      "Dahl's Rock Lizard (Darevskia dahli) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-derjugini": {
    ...
    overview:
      "Derjugin's Lizard (Darevskia derjugini) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-mixta": {
    ...
    overview:
      "Mixed Rock Lizard (Darevskia mixta) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-obscura": {
    ...
    location: "Georgia",
    description:
      "Obscure Rock Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Obscure Rock Lizard (Darevskia obscura) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-pontica": {
    ...
    location: "Georgia",
    description:
      "Pontic Meadow Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Pontic Meadow Lizard (Darevskia pontica) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-portschinskii": {
    ...
    overview:
      "Portschinsky's Lizard (Darevskia portschinskii) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-praticola": {
    ...
    overview:
      "Meadow Lizard (Darevskia praticola) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-raddei": {
    ...
    overview:
      "Radde's Lizard (Darevskia raddei) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "darevskia-valentini": {
    ...
    overview:
      "Valentin's Lizard (Darevskia valentini) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Rocky outcrops, cliffs, stone walls and open montane or foothill slopes.",
    diet: "Mostly small invertebrates, especially insects and spiders.",
    behavior:
  ...
  "dolichophis-caspius": {
    ...
    location: "Georgia",
    description:
      "Caspian Whip Snake — recorded from Georgia. Candidate species.",
    overview:
      "Caspian Whip Snake (Dolichophis caspius) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
    ...
    behavior:
      "Activity pattern varies from diurnal hunters to secretive fossorial or nocturnal species.",
    conservation:
      "Recorded in Georgia. See IUCN for global status where assessed.",
    stats: [
      {
        label: "Habitat",
  ...
  "eirenis-collaris": {
    ...
    overview:
      "Collared Dwarf Snake (Eirenis collaris) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "eirenis-modestus": {
    ...
    overview:
      "Ring-headed Dwarf Snake (Eirenis modestus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Stony slopes and dry open habitats with cover under rocks.",
    diet: "Mostly insects and other small invertebrates.",
    behavior:
      "Activity pattern varies from diurnal hunters to secretive fossorial or nocturnal species.",
  ...
  "emys-orbicularis": {
    ...
    overview:
      "European Pond Turtle (Emys orbicularis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    ...
    behavior:
      "Diurnal basking is common in aquatic turtles; tortoises are terrestrial and often most active in warm weather.",
    conservation:
      "Recorded in Georgia. Many turtles face habitat loss and collection pressure worldwide.",
    stats: [
      {
        label: "Habitat",
  ...
  "eremias-arguta": {
    ...
    overview:
      "Steppe-Runner (Eremias arguta) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
      "Mostly diurnal; many species bask on rocks or vegetation and retreat to crevices when threatened.",
    conservation:
  ...
  "eremias-velox": {
    ...
    overview:
      "Rapid Racerunner (Eremias velox) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "eryx-jaculus": {
    ...
    overview:
      "Javelin Sand Boa (Eryx jaculus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "eumeces-schneiderii": {
    ...
    overview:
      "Schneider's Skink (Eumeces schneiderii) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Loose soil, leaf litter, stones and dry open habitats.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
      "Often secretive; many skinks move quickly through litter or under stones.",
  ...
  "hemorrhois-ravergieri": {
    ...
    overview:
      "Spotted Whip Snake (Hemorrhois ravergieri) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open country, scrub, rocky slopes or woodland edges depending on species.",
    diet: "Small vertebrates and/or invertebrates depending on species — lizards, rodents, amphibians or insects.",
    behavior:
  ...
  "hyla-orientalis": {
    ...
    overview:
      "Eastern Treefrog (Hyla orientalis) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "hyla-savignyi": {
    ...
    overview:
      "Yellow-Lemon Treefrog (Hyla savignyi) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "lacerta-agilis": {
    ...
    overview:
      "Sand Lizard (Lacerta agilis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "lacerta-media": {
    ...
    location: "Georgia",
    description:
      "Caucasian Green Lizard — recorded from Georgia. Candidate species.",
    overview:
      "Caucasian Green Lizard (Lacerta media) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "lacerta-strigata": {
    ...
    overview:
      "Striped Lizard (Lacerta strigata) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "lissotriton-lantzi": {
    ...
    location: "Georgia",
    description:
      "Caucasian Smooth Newt — recorded from Georgia. Candidate species.",
    overview:
      "Caucasian Smooth Newt (Lissotriton lantzi) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "malpolon-insignitus": {
    ...
    overview:
      "Eastern Montpellier Snake (Malpolon insignitus) is recorded from Georgia. It is treated as a candidate species pending further integrative validation. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "mauremys-caspica": {
    ...
    overview:
      "Caspian Turtle (Mauremys caspica) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Ponds, lakes, slow rivers and wetlands.",
    diet: "Varies by species — from mostly herbivorous tortoises to omnivorous freshwater turtles.",
    behavior:
      "Diurnal basking is common in aquatic turtles; tortoises are terrestrial and often most active in warm weather.",
  ...
  "mertensiella-caucasica": {
    ...
    overview:
      "Caucasian Salamander (Mertensiella caucasica) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Cool moist forests, streams and mountain wetlands.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
      "Activity is strongly seasonal and tied to moisture; many species breed in springs, ponds or streams.",
  ...
  "ommatotriton-ophryticus": {
    ...
    overview:
      "Northern Banded Newt (Ommatotriton ophryticus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Cool moist forests, streams and mountain wetlands.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
      "Activity is strongly seasonal and tied to moisture; many species breed in springs, ponds or streams.",
  ...
  "ophisops-elegans": {
    ...
    overview:
      "Snake-Eyed Lizard (Ophisops elegans) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "paralaudakia-caucasia": {
    ...
    overview:
      "Caucasian Agama (Paralaudakia caucasia) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "pelobates-syriacus": {
    ...
    overview:
      "Eastern Spadefoot (Pelobates syriacus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "pelodytes-caucasicus": {
    ...
    overview:
      "Caucasian Parsley Frog (Pelodytes caucasicus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "pelophylax-ridibundus": {
    ...
    overview:
      "Marsh Frog (Pelophylax ridibundus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "phoenicolacerta-laevis": {
    ...
    overview:
      "Lebanon Lizard (Phoenicolacerta laevis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. It is introduced in Georgia. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open ground, scrub, forest edges or sandy/steppe habitats depending on species.",
    diet: "Primarily insects and other small invertebrates; larger lizards may also take small vertebrates.",
    behavior:
  ...
  "rana-macrocnemis": {
    ...
    overview:
      "Caucasian Brown Frog (Rana macrocnemis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Wetlands, ponds, moist forests or open habitats near breeding water.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
  ...
  "tenuidactylus-caspius": {
    ...
    location:
      "Georgia — natural range in the extreme southeast; also synanthropic populations in eastern towns and recorded in Kutaisi and Sokhumi",
    description:
      "A small nocturnal gecko recorded from Georgia — natural range in the far southeast, also in some towns.",
    overview:
      "The Caspian gecko (Tenuidactylus caspius) is a small climbing gecko confirmed for Georgia by. The checklist notes a natural range in the extreme southeast and synanthropic populations in eastern settlements, with additional records from Kutaisi and Sokhumi. It is biologically confirmed and feeds mainly on small arthropods at night.",
    habitat:
      "Rocky and urban walls, stone piles and dry open habitats; in Georgia the natural range is the extreme southeast, with additional synanthropic colonies in towns.",
    diet: "Nocturnal insectivore — mostly small arthropods.",
    behavior:
      "Primarily nocturnal/crepuscular gecko; climbs vertical surfaces and hides in crevices by day.",
    conservation:
      "Recorded in Georgia. Local threats may include habitat degradation and collection.",
    stats: [
      {
  ...
  "testudo-graeca": {
    ...
    location:
      "Georgia — T. g. ibera widespread in eastern Georgia; T. g. nikolskii described from western Georgia and considered rare",
    description: "Mediterranean Tortoise — recorded from Georgia.",
    overview:
      "Mediterranean Tortoise (Testudo graeca) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Dry grasslands, scrub and open foothills; subspecies differ between eastern and western Georgia.",
  ...
  "trachemys-scripta": {
    ...
    overview:
      "Pond Slider (Trachemys scripta) is recorded from Georgia. It is listed as biologically confirmed in that checklist. It is introduced in Georgia. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Ponds, lakes, slow rivers and wetlands.",
    diet: "Varies by species — from mostly herbivorous tortoises to omnivorous freshwater turtles.",
    behavior:
      "Diurnal basking is common in aquatic turtles; tortoises are terrestrial and often most active in warm weather.",
    conservation:
      "Introduced in Georgia. Can compete with native aquatic turtles.",
    stats: [
      {
        label: "Habitat",
        value: "Terrestrial / freshwater",
  ...
  "triturus-karelinii": {
    ...
    overview:
      "Eastern Crested Newt (Triturus karelinii) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat: "Cool moist forests, streams and mountain wetlands.",
    diet: "Mostly invertebrates — insects, worms and other small prey; aquatic larvae often feed on small aquatic invertebrates.",
    behavior:
      "Activity is strongly seasonal and tied to moisture; many species breed in springs, ponds or streams.",
  ...
  "vipera-ammodytes": {
    ...
    identification: {
      summary:
        "The nose-horned viper is one of Europe’s most dangerous vipers. The horn-like snout growth is the key mark — and it is rare in Georgia.",
      traits: [
  ...
  "vipera-renardi": {
    ...
    overview:
      "The eastern steppe viper (Vipera renardi), also called Renard's viper, is a venomous member of the viper family in the ursinii–renardi complex. It ranges from south-eastern Europe into Central Asia; IUCN also includes Transcaucasian populations in Armenia, Azerbaijan, and Georgia. In Georgia it occurs on the Javakheti and Erusheti plateaus (often treated as V. r. eriwanensis / southern steppe viper) and in the east around the Shiraki Plateau and Dedoplistskaro (Shemakha group / kakhetiensis). It is relatively small (about 40–60 cm), with a dark dorsal zigzag, and prefers open steppe habitats. The European regional IUCN assessment lists it as Vulnerable due to habitat loss.",
    habitat:
  ...
  "xerotyphlops-vermicularis": {
    ...
    overview:
      "European Blind Snake (Xerotyphlops vermicularis) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
  ...
  "zamenis-hohenackeri": {
    ...
    overview:
      "Transcaucasian Ratsnake (Zamenis hohenackeri) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open country, scrub, rocky slopes or woodland edges depending on species.",
    diet: "Small vertebrates and/or invertebrates depending on species — lizards, rodents, amphibians or insects.",
    behavior:
  ...
  "zamenis-longissimus": {
    ...
    overview:
      "Aesculapian Snake (Zamenis longissimus) is recorded from Georgia. It is listed as biologically confirmed in that checklist. This page summarises occurrence and general natural history from scientific sources; fine-scale districts are given only when explicitly supported.",
    habitat:
      "Open country, scrub, rocky slopes or woodland edges depending on species.",
    diet: "Small vertebrates and/or invertebrates depending on species — lizards, rodents, amphibians or insects.",
    behavior:
