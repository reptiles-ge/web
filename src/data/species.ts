...
export const species: Species[] = [
  ...
  },
  {
    ...
    behavior:
      "დღის აქტიურია, განსაკუთრებით გაზაფხულზე; სიცხეში უფრო ფარულია და თავშესაფარს ეძებს. შეწყვილება ჩვეულებრივ გაზაფხულზეა. კვერცხისმდებია: დებს დაახლოებით 3–24 კვერცხს; ინკუბაცია დაახლოებით 60–75 დღეა. საფრთხისას შეიძლება იკანკალოს კუდით (ჭყივილის იმიტაცია), გასდეს განავალი ან იკბინოს — თუმცა შხამი არ აქვს.",
    conservation:
    ...
    stats: [
      { label: "ჰაბიტატი", value: "ტყე, ფიჭვნარი, ჭალა" },
      { label: "სიგრძე", value: "დაახლ. 90–122 სმ" },
      { label: "შხამი", value: "არა — უვნებელი" },
      { label: "კონსერვაცია", value: "ნაკლებად საფრთხის ქვეშ (LC)" },
      { label: "გავრცელება", value: "აშშ-ის სამხრ.–აღმ." },
      { label: "ოჯახი", value: "Colubridae" },
    ],
    facts: [
    ...
    faq: [
      {
        ...
        answer:
          "არა — შხამი არ აქვს და ადამიანისთვის უვნებელია. საფრთხისას შეიძლება იკბინოს ან კუდი იკანკალოს, მაგრამ სამედიცინო საფრთხე არ წარმოადგენს. ბუნებაში სასარგებლოა, რადგან მღრღნელებსა და შხამიან გველებსაც იჭერს.",
      },
      {
        question: "სად გვხვდება?",
        answer:
          "აშშ-ის სამხრეთ-აღმოსავლეთში — სამხრეთ ნიუ-ჯერსიდან ფლორიდამდე და დასავლეთით ალაბამამდე. ფიჭვნარებში, შერეულ ტყეებში, ბალახოვან ადგილებსა და ჭაობებთან ახლოს.",
      },
      {
        question: "რატომ ეწოდება მეფე გველი?",
        answer:
          "ინგლისური kingsnake სხვა გველების — მათ შორის შხამიანების — ჭამის უნარს უკავშირდება; „მეფედ“ ითვლება გველების შორის. ჯაჭვური ნახატის გამო ასევე chain kingsnake ეწოდება.",
      },
      {
        question: "რას ჭამს?",
        answer:
          "მღრღნელებს, ფრინველებს, კვერცხებს, ხვლიკებს, ამფიბიებსა და სხვა გველებს. მსხვერპლს შეკუმშვით ანეიტრალებს; შხამიანი გველების შხამის მიმართ მდგრადია.",
      },
      {
        question: "როგორ მრავლდება?",
        answer:
          "კვერცხისმდებია. შეწყვილება გაზაფხულზეა; დებს დაახლოებით 3–24 კვერცხს, რომლებიც დაახლოებით 60–75 დღეში იჩეკება.",
      },
    ],
  },
  {
