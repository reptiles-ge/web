...
export const species: Species[] = [
  {
    ...
    "overview": "მწვანე ანაკონდა სამხრეთ ამერიკის ტროპიკული ჭაობებისა და მდინარეების გიგანტი გველია. ის დედამიწის ყველაზე მძიმე გველია და ნადირობს წყალში ჩასაფრებით.",
    "habitat": "გავრცელებულია ამაზონის აუზში, ორინოკოსა და სხვა ტროპიკულ მდინარეებში. უპირატესობას ანიჭებს ნელ, მოღრუბლულ წყლებსა და ჭაობებს.",
    "diet": "იჭერს თევზებს, ფრინველებს, კაიმანებსა და ძუძუმწოვრებს. მსხვერპლს ახრჩობს და მთლიანად ყლაპავს.",
    "behavior": "ძირითადად წყლის ცხოველია. შეიძლება საათობით უძრავად ელოდოს ნადირს ზედაპირთან ახლოს, მხოლოდ ცხვირით ჰაერში.",
    "conservation": "ამჟამად ფართოდ გავრცელებულია, თუმცა ჰაბიტატის განადგურება და ნადირობა ზოგ რეგიონში საფრთხეს ქმნის.",
    "danger": "High",
    "image": "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1024&q=80",
    "gallery": [
      {
  ...
  },
  {
    ...
    "overview": "პანტერის ქამელეონი მადაგასკარის ერთ-ერთი ყველაზე ფერადი ქვეწარმავალია. მისი ფერის ცვლილება სოციალურ სიგნალსა და ფიზიოლოგიურ მდგომარეობას ასახავს.",
    "habitat": "ცხოვრობს მადაგასკარის აღმოსავლეთ და ჩრდილოეთ სანაპირო ტყეებში. ხშირად გვხვდება ბუჩქნარებსა და ხეების ქვედა იარუსზე.",
    "diet": "იჭერს მწერებს გრძელი, წებოვანი ენით. ნადირობს ვიზუალურად — თვალები დამოუკიდებლად მოძრაობს.",
    "behavior": "ტერიტორიულია. მამრები ერთმანეთთან კონფლიქტისას ფერს ცვლიან და სხეულს ადიდებენ. ნელი, რხეული სიარულით ბაძავს ფოთლის მოძრაობას.",
    "conservation": "ველური პოპულაციები ზეწოლის ქვეშაა ჰაბიტატის დაკარგვისა და ვაჭრობის გამო, თუმცა ტყვეობაში ფართოდ მრავლდება.",
    "danger": "Harmless",
    "image": "https://images.unsplash.com/photo-1504450874802-0ba0bcd9e6b2?auto=format&fit=crop&w=1024&q=80",
    "gallery": [
      {
  ...
  },
  {
    ...
    "overview": "ლურჯი შხამიანი ბაყაყი სამხრეთ ამერიკის ტროპიკული ტყეების პატარა, მაგრამ საშიში ამფიბიაა. მისი კაშკაშა ფერი მტაცებლებს ტოქსიკურობას უცხადებს.",
    "habitat": "ცხოვრობს სურინამის, ფრანგული გვიანისა და ბრაზილიის ტროპიკულ ტყეებში — ტენიან ფოთლოვან საფარზე.",
    "diet": "იჭერს ჭიანჭველებს, ტერმიტებსა და სხვა მცირე უხერხემლოებს, საიდანაც ტოქსინებს იღებს.",
    "behavior": "დღის აქტიურია. მამრები ტერიტორიას იცავენ და კვერცხებს ატენიანებენ. ტყვეობაში ტოქსიკურობა მცირდება, რადგან დიეტა იცვლება.",
    "conservation": "ზოგი პოპულაცია ჰაბიტატის განადგურებითაა საფრთხის ქვეშ. ველური ვაჭრობა რეგულირებულია CITES-ით.",
    "danger": "Moderate",
    "image": "https://images.unsplash.com/photo-1496074732535-1023808c2951?auto=format&fit=crop&w=1024&q=80",
    "gallery": [
      {
        "src": "https://images.unsplash.com/photo-1496074732535-1023808c2951?auto=format&fit=crop&w=1200&q=80"
      },
  ...
  },
  {
    ...
    "overview": "კომოდოს ვარანი დედამიწის ყველაზე დიდი ცოცხალი ხვლიკია. ის ინდონეზიის რამდენიმე კუნძულზე ცხოვრობს და ცნობილია ძალით, მოთმინებითა და შხამიანი ნაკბენით.",
    "habitat": "გავრცელებულია კომოდოს, რინკას, ფლორესისა და გილის კუნძულებზე. ცხოვრობს მშრალ ტყეებში, სავანასა და სანაპირო დაბლობებზე.",
    "diet": "იკვებება ირმებით, გარეული ღორებით, ფრინველებითა და ლეშით. ახალგაზრდები ხშირად ხეებზე ცხოვრობენ და მწერებით იკვებებიან.",
    "behavior": "მარტოხელა მტაცებელია. ნადირობს ჩასაფრებით და შეიძლება საათობით ელოდოს მსხვერპლს. ტერიტორიულია, განსაკუთრებით გამრავლების სეზონზე.",
    "conservation": "IUCN-ის მიხედვით მოწყვლადი სახეობაა. საფრთხეებია ჰაბიტატის დაკარგვა, ადამიანთან კონფლიქტი და კლიმატის ცვლილება.",
    "danger": "High",
    "image": "https://images.unsplash.com/photo-1551244072-5d12893278ab?auto=format&fit=crop&w=1024&q=80",
    "gallery": [
      {
        "src": "https://images.unsplash.com/photo-1551244072-5d12893278ab?auto=format&fit=crop&w=1200&q=80"
      },
  ...
  },
  {
    ...
    "overview": "მწვანე ზღვის კუ ტროპიკული ოკეანეების მიგრანტი გიგანტია. ის ათასობით კილომეტრს გადის საკვები ადგილებიდან იმ სანაპირომდე, სადაც დაიბადა.",
    "habitat": "გავრცელებულია ატლანტის, წყნარი და ინდოეთის ოკეანეების ტროპიკულ და სუბტროპიკულ წყლებში. ბუდობს ქვიშიან სანაპიროებზე.",
    "diet": "ზრდასრულები ძირითადად ზღვის ბალახითა და წყალმცენარეებით იკვებებიან — აქედან მოდის სახელი „მწვანე“.",
    "behavior": "ნავიგაციას იყენებს დედამიწის მაგნიტური ველით. დედალი ყოველ რამდენიმე წელიწადში ბრუნდება იმავე სანაპიროზე კვერცხების დასადებად.",
    "conservation": "IUCN-ის მიხედვით საფრთხის ქვეშაა. მთავარი საფრთხეებია ბადეებში მოხვედრა, პლასტიკი, სანაპირო განვითარება და კლიმატის ცვლილება.",
    "danger": "Harmless",
    "image": "https://images.unsplash.com/photo-1437622368342-7a3d73a34c8f?auto=format&fit=crop&w=1024&q=80",
    "gallery": [
      {
        "src": "https://images.unsplash.com/photo-1437622368342-7a3d73a34c8f?auto=format&fit=crop&w=1200&q=80"
      },
...
export const speciesEn: Record<string, SpeciesTranslation> = {
  "anaconda": {
    ...
    "overview": "The green anaconda is a giant snake of South America's tropical swamps and rivers. It is the heaviest snake on Earth and hunts by ambush in water.",
    "habitat": "Distributed across the Amazon Basin, the Orinoco, and other tropical rivers. It prefers slow, murky waters and swamps.",
    "diet": "It preys on fish, birds, caimans, and mammals. It kills prey by constriction and swallows it whole.",
    "behavior": "It is primarily aquatic. It can remain motionless for hours awaiting prey near the surface, with only its nostrils above the water.",
    "conservation": "It is currently widespread, though habitat destruction and hunting pose a threat in some regions.",
    "stats": [
      {
        "label": "Habitat",
        "value": "Amazon Basin"
  ...
  "chameleon": {
    ...
    "overview": "The panther chameleon is one of Madagascar's most colorful reptiles. Its color change reflects social signaling and physiological state.",
    "habitat": "It lives in the coastal forests of eastern and northern Madagascar. It is often found in scrub and the lower canopy of trees.",
    "diet": "It catches insects with its long, sticky tongue. It hunts visually — its eyes move independently.",
    "behavior": "It is territorial. Males change color and inflate their bodies when facing off against each other. Its slow, swaying gait mimics the movement of a leaf.",
    "conservation": "Wild populations are under pressure from habitat loss and trade, though it breeds widely in captivity.",
    "stats": [
      {
        "label": "Habitat",
        "value": "Madagascar"
  ...
  "frog": {
    ...
    "overview": "The dyeing poison dart frog is a small but dangerous amphibian of South America's tropical forests. Its bright color signals its toxicity to predators.",
    "habitat": "It lives in the tropical forests of Suriname, French Guiana, and Brazil — on the moist leaf litter of the forest floor.",
    "diet": "It catches ants, termites, and other small invertebrates, from which it derives its toxins.",
    "behavior": "It is active by day. Males guard territory and keep eggs moist. In captivity its toxicity decreases as its diet changes.",
    "conservation": "Some populations are threatened by habitat destruction. The wildlife trade is regulated under CITES.",
    "stats": [
      {
        "label": "Habitat",
  ...
  "komodo": {
    ...
    "overview": "The Komodo dragon is the largest living lizard on Earth. It lives on a handful of Indonesian islands and is known for its strength, patience, and venomous bite.",
    "habitat": "Distributed on the islands of Komodo, Rinca, Flores, and Gili Motang. It lives in dry forests, savanna, and coastal lowlands.",
    "diet": "It feeds on deer, wild boar, birds, and carrion. Juveniles often live in trees and feed on insects.",
    "behavior": "It is a solitary predator. It hunts by ambush and can wait for prey for hours. It is territorial, especially during the breeding season.",
    "conservation": "Classified as Vulnerable by the IUCN. Threats include habitat loss, conflict with humans, and climate change.",
    "stats": [
      {
        "label": "Habitat",
  ...
  "turtle": {
    ...
    "overview": "The green sea turtle is a migratory giant of the tropical oceans. It travels thousands of kilometers from feeding grounds to the beach where it was born.",
    "habitat": "Distributed across the tropical and subtropical waters of the Atlantic, Pacific, and Indian Oceans. It nests on sandy beaches.",
    "diet": "Adults feed mainly on seagrass and algae — the source of the name \"green.\"",
    "behavior": "It navigates using Earth's magnetic field. Females return to the same beach every few years to lay eggs.",
    "conservation": "Classified as Endangered by the IUCN. Major threats include entanglement in nets, plastic, coastal development, and climate change.",
    "stats": [
      {
        "label": "Habitat",
