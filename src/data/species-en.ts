...
export const speciesEn: Record<string, SpeciesTranslation> = {
  ...
  "lampropeltis-getula": {
    ...
    description:
      "A harmless chain kingsnake — glossy black scales with white-to-yellow chain bands; known for eating venomous snakes.",
    overview:
    ...
    habitat:
      "It favors pinewoods, mixed forests, grasslands, and landscapes near wetlands — sandy uplands, river floodplains, and leaf litter. Studies show it spends most of its time concealed under soil and leaf litter; it is often found with dense shrubbery and a thick leaf layer.",
    ...
    behavior:
      "It is diurnal, especially in spring; in heat it becomes more secretive and seeks cover. Mating usually occurs in spring. It is egg-laying: clutches are roughly 3–24 eggs; incubation lasts about 60–75 days. When threatened it may vibrate its tail (mimicking a rattlesnake), musk, or bite — but it is not venomous.",
    conservation:
      "It is Least Concern on the IUCN Red List. Even so, declines have been recorded in some southeastern populations — from habitat fragmentation, roadkill, persecution, invasive fire ants, and locally excessive collection. It is legally protected in Georgia and South Carolina. It benefits ecosystems by controlling rodents and venomous snakes.",
    stats: [
      { label: "Habitat", value: "Forest, pine, floodplain" },
      { label: "Length", value: "approx. 90–122 cm" },
      { label: "Venom", value: "None — harmless" },
      { label: "Conservation", value: "Least Concern (LC)" },
      { label: "Range", value: "SE United States" },
      { label: "Family", value: "Colubridae" },
    ],
    facts: [
    ...
    faq: [
      {
        ...
        answer:
          "No — it is not venomous and is harmless to humans. When threatened it may bite or vibrate its tail, but it poses no medical risk. In the wild it is beneficial because it takes rodents and venomous snakes.",
      },
      {
        question: "Where is it found?",
        answer:
          "In the southeastern United States — from southern New Jersey through Florida and west into Alabama. In pinewoods, mixed forests, grasslands, and near wetlands.",
      },
      {
        question: "Why is it called a kingsnake?",
        answer:
          "The English name kingsnake refers to its habit of eating other snakes — including venomous ones; it is considered a \"king\" among snakes. The chain-like pattern also gives it the name chain kingsnake.",
      },
      {
        question: "What does it eat?",
        answer:
          "Rodents, birds, eggs, lizards, amphibians, and other snakes. It subdues prey by constriction and is resistant to the venom of pit vipers.",
      },
      {
        question: "How does it reproduce?",
        answer:
          "It is egg-laying. Mating is in spring; it lays roughly 3–24 eggs, which hatch after about 60–75 days.",
      },
    ],
  },
  komodo: {
